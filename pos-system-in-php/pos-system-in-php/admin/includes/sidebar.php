        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link collapsed" href="#"
                    data-bs-toggle="collapse" data-bs-target="#collapseCategory" aria-expanded="false" aria-controls="collapseCategory">
                ...
                <div class="sb-sidenav-menu-heading">Inventory Logs</div>
                ...
                <div class="collapse" id="collapseInventory" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="inventory-log-create.php">Add Inventory Log</a>
                        <a class="nav-link" href="inventory-logs.php">View Inventory Logs</a>
                    </nav>
                </div>
