<?php
$product = Product::readById($_GET["id"]);
                ...
                <div class="featured-product mb-4">
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-3.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-4.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-5.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                            <h6 class="mb-2">Smart Camera</h6>
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-6.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                            <h6 class="mb-2">Smart Camera</h6>
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-7.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                    ...
                    <div class="featured-product-item">
                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                            <img src="<?php echo BASE_URL; ?>assets/img/product-8.png" class="img-fluid rounded"
                                alt="Image">
                        </div>
                        <div>
                            <h6 class="mb-2">Smart Camera</h6>
                    ...
                    <div class="col-xl-6">
                        <div class="single-carousel owl-carousel">
                           ...
                           <div class="single-item"
                                data-dot="<img class='img-fluid' src='<?php echo BASE_URL; ?>admin/<?= $product['image']?>' alt=''>">
                                <div class="single-inner bg-light rounded">
                                    <img src="<?php echo BASE_URL; ?>admin/<?= $product['image']?>" class="img-fluid rounded"
                                        alt="Image">
                                </div>
                            </div>
                        </div>
            ...
            <div class="related-item rounded">
                <div class="related-item-inner border rounded">
                    <div class="related-item-inner-item">
                        <img src="<?php echo BASE_URL; ?>assets/img/product-3.png" class="img-fluid w-100 rounded-top"
                            alt="">
